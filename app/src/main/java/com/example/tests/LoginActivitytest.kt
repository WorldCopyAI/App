...
class LoginActivitytest : AppCompatActivity(), View.OnClickListener {
        ...
        firebaseAuth.signInWithCredential(credential)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    Log.w("login_activity", "firebaseAuthWithGoogle 성공", task.exception)
                    toMainActivity(firebaseAuth?.currentUser)
                } else {
                    Log.w("login_activity", "firebaseAuthWithGoogle 실패", task.exception)
